...
shinyServer(function(input,output,clientData, session) {
  ...
  # initialize table for scenario parameters
  ...
  # dynamic text for mixture and power rates of success
  ...
  # create prior to posterior plot
  ...
  # create mixture prior density plot
...
gp=gpar(col="black", fontsize=13, fontface="italic")))
  ...
  # create power prior density plot
